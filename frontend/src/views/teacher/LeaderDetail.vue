...
.time { color: #999; font-size: 13px; margin-top: 8px; }
.detail-card { border-radius: 10px; }
.cover { margin-bottom: 12px; }
.cover-img { width: 100%; height: auto; max-height: 520px; object-fit: contain; border-radius: 8px; display: block; background: #f5f5f5; }
.detail-content { line-height: 1.9; color: #333; white-space: pre-wrap; overflow-wrap: anywhere; word-break: break-word; }
