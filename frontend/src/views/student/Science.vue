...
export default {
  ...
  setup() {
    ...
    const openScienceDetail = (module, item) => {
      ...
      if (module === 'news') {
        router.push(`/student/science/news/${item.id}`)
        return
      }
      if (module === 'knowledge') {
        router.push(`/student/science/knowledge/${item.id}`)
      }
    }

    const handleMore = (module) => {
      if (module === 'empower') {
        router.push('/student/science/empower/list')
        return
      }
      if (module === 'news') {
        router.push('/student/science/news/list')
        return
      }
      if (module === 'knowledge') {
        router.push('/student/science/knowledge/list')
        return
      }
